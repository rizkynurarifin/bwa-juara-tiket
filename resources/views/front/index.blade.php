                            ...
                            <div class="swiper-slide !w-fit">
                                <a href="{{ route('front.details', $popularTicket->slug) }}" class="card">
                                    <div
                                        ...
                                        <img src="{{ Storage::url($popularTicket->thumbnail) }}"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-[14px]">
                                    <div
                                        ...
                                        <img src="{{ Storage::url($newTicket->thumbnail) }}"
                                    ...
                                    <div class="flex flex-col gap-[6px]">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <p class="font-semibold text-xs leading-[18px]">
                                                {{ $newTicket->seller->name }}
                                            </p>
                                        </div>
                                        <p class="font-bold text-sm leading-[21px] text-[#F97316]">
                                            Rp {{ number_format($newTicket->price, 0, ',', '.') }}
                                        </p>
                                    </div>
                                </div>
                                <p
